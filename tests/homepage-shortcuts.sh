...
assert_contains "Homepage exposes native OpenClaw Control UI" \
    "https://aisha.tail4553c9.ts.net/openclaw/" \
    "$REPO_ROOT/configs/homepage/services.yaml"
assert_contains "OpenClaw card is labeled honestly" \
    "Native OpenClaw Control UI" \
    "$REPO_ROOT/configs/homepage/services.yaml"
assert_not_contains "Homepage does not label Aisha chat as OpenClaw" \
