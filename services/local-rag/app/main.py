...
def health() -> dict[str, Any]:
    ...
    return {
        ...
        "max_concurrent_requests": concurrency_limiter.max_concurrent,
        "max_request_body_bytes": MAX_REQUEST_BODY_BYTES,
    }
